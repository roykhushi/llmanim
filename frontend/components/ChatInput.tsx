      ...
      <form onSubmit={handleSubmit} className="container max-w-3xl">
        <div className="flex gap-2">
          <Textarea
            ...
            disabled={disabled}
          />
          <Button type="submit" className="bg-purple-400 hover:bg-purple-400 dark:bg-white dark:hover:bg-white dark:text-black dark:hover:text-black" disabled={disabled || !input.trim()}>
            Send
          </Button>
        </div>
        <p className="text-xs text-muted-foreground mt-2 text-center">
          Try describing math concepts and equations that  you would like to see animated.
        </p>
      </form>
    </motion.div>
  );
