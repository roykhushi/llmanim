  ...
  (
    ...
    if (isMobile) {
      return (
        <>
          {openMobile && (
            <div
              className="fixed inset-0 top-20 z-50 bg-black/50"
          ...
          <div
            ref={ref}
            className={cn(
              "fixed z-50 gap-0 bg-sidebar p-0 text-sidebar-foreground shadow-lg transition-transform duration-200 ease-in-out",
              side === "left" ? "top-20 bottom-0 left-0 h-[calc(100vh-5rem)] w-[--sidebar-width-mobile] border-r" : "top-20 bottom-0 right-0 h-[calc(100vh-5rem)] w-[--sidebar-width-mobile] border-l",
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 fixed top-20 z-30 hidden h-[calc(100vh-5rem)] w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex",
            side === "left"
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    ...
    >
      {showIcon && (
        <div className="size-4 rounded-sm bg-sidebar-border animate-pulse" />
      )}
      <div
        className="h-4 bg-sidebar-border rounded-sm animate-pulse"
        style={{
          width,
        }}
      />
